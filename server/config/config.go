...
func list(writer http.ResponseWriter, request *http.Request) {
	...
	for k, v := range ProjectConfig.Branches {
		branchNames[k] = v.Description
	}
	projectRes := ProjectRes{Project: ProjectConfig.Project, Description: ProjectConfig.Description, Branches: branchNames}
